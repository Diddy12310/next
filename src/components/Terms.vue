  ...
  <div class="terms">
    <v-container fluid class="text-center pt-0">
      <v-row>
        ...
        <v-col sm="12" class="deep-purple darken-2 elevation-5 py-4">
          <h3 class="mt-2 text-h4 grey--text font-weight-light">Paradigm</h3>
        </v-col>
      </v-row>
    </v-container>
    <div style="text-align: left; margin: auto; width: 80vw; padding-top: 20px;">
      ...
      <p>
        ...
        www.theparadigmdev.com website as well as any other media form, media channel, mobile website or mobile application related,
        ...
        <br><br>
        <b class="text-subtitle-2 font-weight-bold">IF YOU DO NOT AGREE WITH ALL OF THESE TERMS
      ...
      <h4 class="title pb-2">Intellectual Property Rights</h4>
      <p>
      ...
      <h4 class="title pb-2">User Generated Contributions</h4>
      <p>
      ...
      <h4 class="title pb-2">Site Management</h4>
      <p>
      ...
      <h4 class="title pb-2">Copyright Infringements</h4>
      <p>
      ...
      <h4 class="title pb-2">Term and Termination</h4>
      <p>
      ...
      <p>
      <h4 class="title pb-2">Modifications and Interruptions</h4>
      <p>
      ...
      <h6 class="text-subtitle-2 pb-2">Informal Negotiations</h6>
      <p>
      ...
      <h6 class="text-subtitle-2 pb-2">Binding Arbitration</h6>
      <p>
      ...
      <h6 class="text-subtitle-2 pb-2">Restrictions</h6>
      <p>
      ...
      <h6 class="text-subtitle-2 pb-2">Exeptions to Informal Negotiations and Arbitrations</h6>
      <p>
      ...
      <h4 class="title pb-2">Corrections</h4>
      <p>
      ...
      <h4 class="title pb-2">Disclaimer</h4>
      <p>
      ...
      <h4 class="title pb-2">Limitations of Liability</h4>
      <p>
      ...
      <h4 class="title pb-2">Indemnifications</h4>
      <p>
      ...
      <h4 class="title pb-2">User Data</h4>
      <p>
      ...
      <h4 class="title pb-2">Electronic Communications, Transactions, and Signatures</h4>
      <p>
      ...
      <h4 class="title pb-2">Californian Users and Residents</h4>
      <p>
      ...
      <h4 class="title pb-2">Miscellaneous</h4>
      <p>
      ...
      <h6 class="text-subtitle-2 pb-2">Information Collection from Other Sources</h6>
      ...
      <h4 class="title pb-2">Information Sharing</h4>
      <p>
      ...
      <h4 class="title pb-2">Information Lifespan</h4>
      <p>
      ...
      <h4 class="title pb-2">Information Safety</h4>
      <p>
      ...
      <h4 class="title pb-2">Information of Minors</h4>
      <p>
      ...
      <h4 class="title pb-2">Privacy Rights</h4>
      <p>
      ...
      <h6 class="text-subtitle-2 pb-2">Account Information</h6>
      <p>
      ...
      <h4 class="title pb-2">Controls for Do-Not-Track Features</h4>
      <p>
      ...
      <h4 class="title pb-2">California-Specific Privacy Rights</h4>
      <p>
      ...
      <h4 class="title pb-2">Policy Updates</h4>
      <p>
