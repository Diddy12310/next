<template>
  <div class="terms">
    <v-container fluid class="text-center pt-0">
      <v-row>
        ...
        <v-col sm="12" class="deep-purple darken-2 elevation-5 py-4">
          <h3 class="text-h4 grey--text font-weight-light">Paradigm</h3>
        </v-col>
      </v-row>
    </v-container>
    <div style="text-align: left; margin: auto; width: 80vw; padding-top: 20px;">
      ...
      <h4 class="text-h5 pb-2">Intellectual Property Rights</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">User Representations</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">User Registration</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Prohibited Activities</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">User Generated Contributions</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Contribution License</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Submissions</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Site Management</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Copyright Infringements</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Term and Termination</h4>
      <p>
      ...
      <p>
      <h4 class="text-h5 pb-2">Modifications and Interruptions</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Governing Law</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Dispute Resolution</h4>
      <h6 class="text-h6 font-weight-light pb-2">Informal Negotiations</h6>
      <p>
        To expedite resolution and control the cost of any dispute, controversy, or claim related to these Terms of Use (each a "'Dispute" and collectively, the "Disputes") brought by either you or us (individually, a "Party/' and collectively, the "Parties"); the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least thirty (30) days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.
      </p>
      <h6 class="text-h6 font-weight-light pb-2">Binding Arbitration</h6>
      <p>
      ...
      <h6 class="text-h6 font-weight-light pb-2">Restrictions</h6>
      <p>
        The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
      </p>
      <h6 class="text-h6 font-weight-light pb-2">Exeptions to Informal Negotiations and Arbitrations</h6>
      <p>
      ...
      <h4 class="text-h5 pb-2">Corrections</h4>
      <p>
        There may be information on the Site that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Site at any time, without prior notice.
      </p>
      <h4 class="text-h5 pb-2">Disclaimer</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Limitations of Liability</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Indemnifications</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">User Data</h4>
      <p>
        We will maintain certain data that you transmit to the Site for the purpose of managing the performance of the Site, as well as data relating to your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Site. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
      </p>
      <h4 class="text-h5 pb-2">Electronic Communications, Transactions, and Signatures</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Californian Users and Residents</h4>
      <p>
        If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.
      </p>
      <h4 class="text-h5 pb-2">Miscellaneous</h4>
      <p>
      ...
      <v-divider></v-divider>
      <h4 class="text-h5 pb-2 pt-3">Privacy Policy</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Information Collection</h4>
      <h6 class="text-h6 font-weight-light pb-2">Information Automatically Collected</h6>
      <p>
        Zero information is saved about you, your device, or your network when you visit our Site.
      </p>
      <h6 class="text-h6 font-weight-light pb-2">Information Collection from Other Sources</h6>
      <p>
        We do NOT collect data from public databases, marketing partners, or other outside sources.
      </p>
      <h4 class="text-h5 pb-2">Information Use</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Information Sharing</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Information Lifespan</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Information Safety</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Privacy Rights</h4>
      <p>
        You may review, change, or terminate your account at any time.
        <br><br>
        If you are resident in the European Economic Area and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details <a href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.html">here</a>.
      </p>
      <h4 class="text-h5 pb-2">Account Information</h4>
      <p>
      ...
      <h4 class="text-h5 pb-2">Policy Updates</h4>
      <p>
