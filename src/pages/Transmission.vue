<template>
  <div class="transmission">
    ...
    <v-list>
      <v-list-item
        @click="peer = friend"
        v-for="(friend, index) in $root.user.people.approved"
        :key="index"
      >
        <v-list-item-avatar
          ><v-img
    ...
    <v-btn fab fixed bottom left @click="endCall()" v-if="show_peer_video"
