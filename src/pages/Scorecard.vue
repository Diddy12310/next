  ...
  data() {
    return {
			...
			headers: [
				...
				{ text: 'Par', value: 'total', width: '70' },
				{ text: 'Player', value: 'player_bio.last_name' },
				{ text: 'Nat', value: 'player_bio.country', width: '70' },
				{ text: 'On', value: 'thru', width: '65' },
				{ text: 'Cur', value: 'today', width: '70' },
				{ text: 'R1', value: 'rounds[0].strokes', width: '65' },
				{ text: 'R2', value: 'rounds[1].strokes', width: '65' },
				{ text: 'R3', value: 'rounds[2].strokes', width: '65' },
				{ text: 'R4', value: 'rounds[3].strokes', width: '65' },
				{ text: 'Str', value: 'total_strokes', width: '70' }
			],
			players: [],
			timestamp: '',
			tid: ''
